...
import "./TipoEntregaPage.css";
import TipoEntregaDialog from "./TipoEntregaDialog";

const API_URL = `${import.meta.env.VITE_API_URL}/tipos-entrega`;
...
export default function TipoEntregaPage() {
  ...
  return (
    <div className="mui-container">
      <h1 className="mui-title">Tipos de Entrega</h1>
      ...
      <div className="mui-card">
        ...
        <div className="mui-card-body">
          {tipos.length === 0 ? (
            <div className="muted">Aún no hay tipos de entrega creados.</div>
          ) : (
