...
import "./TipoCambioPage.css";
import TipoCambioDialog from "./TipoCambioDialog";

const API_URL = `${import.meta.env.VITE_API_URL}/tipos-cambio`;
...
export default function TipoCambioPage() {
  ...
  return (
    <div className="mui-container">
      <h1 className="mui-title">Tipos de Cambio</h1>
      ...
      <div className="mui-card">
        ...
        <div className="mui-card-body">
          {tipos.length === 0 ? (
            <div className="muted">Aún no hay tipos de cambio creados.</div>
          ) : (
